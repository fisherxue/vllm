...
class EngineArgs:
    ...
    router_logits_output_dir: str | None = ModelConfig.router_logits_output_dir
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument(
            "--router-logits-output-dir",
            **model_kwargs["router_logits_output_dir"],
        )
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            router_logits_output_dir=self.router_logits_output_dir,
